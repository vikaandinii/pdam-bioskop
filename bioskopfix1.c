...
#define hpopcorn    25000
#define hmamigor    30000
#define hhotdog     35000
#define hcola       15000
#define havocado    20000
...
if (pilihan_daerah == 1) {
    ...
    printf("\t|                                               |   1   |   2   |   3   |   4   |   5    |\n");
    printf("\t|----------------------------------------------------------------------------------------|\n");
    printf("\t|    1    | Sweet Home                          | 12.00 | 14.20 | 16.40 | 19.00 | 21.20  |\n");
...
fscanf(baca, "%d", &randomNumber);
fclose(baca);

printf("Bilangan random: %d\n", randomNumber);
printf("Masukkan bilangan random: ");
scanf("%d", &randomNumber);
    ...
    if(cetak=='y' | cetak=='Y'){
        for(i=0; i<tiket; i++){
            ...
            fclose(file);
            srand(10);
            printf("\n Masukkan Kode Ini Untuk Print Tiket: %d\n",rand());
        }
        data_pesanan();
